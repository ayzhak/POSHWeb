...
public class HostedRunspace
{
    ...
    public void InitializeRunspaces(int minRunspaces, int maxRunspaces, string[] modulesToLoad)
    {
        ...
        foreach (var moduleName in modulesToLoad) defaultSessionState.ImportPSModule(moduleName);
        ...
        EventHandler<DataAddedEventArgs> error)
    {
        ...
        using (var ps = PowerShell.Create())
        {
            ...
            foreach (var item in pipelineObjects) Console.WriteLine(item.BaseObject.ToString());
        }
    }
